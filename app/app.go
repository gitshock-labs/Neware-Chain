...
import (
	...
	gtfxmodule "gtfx/x/gtfx"
	gtfxmodulekeeper "gtfx/x/gtfx/keeper"
	gtfxmoduletypes "gtfx/x/gtfx/types"
...
type App struct {
	*baseapp.BaseApp
	...
	GtfxKeeper gtfxmodulekeeper.Keeper
...
func New(
	...
	app.GtfxKeeper = *gtfxmodulekeeper.NewKeeper(
		appCodec,
		keys[gtfxmoduletypes.StoreKey],
		keys[gtfxmoduletypes.MemStoreKey],
		app.GetSubspace(gtfxmoduletypes.ModuleName),
	)
	gtfxModule := gtfxmodule.NewAppModule(appCodec, app.GtfxKeeper, app.AccountKeeper, app.BankKeeper)
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey sdk.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(gtfxmoduletypes.ModuleName)
